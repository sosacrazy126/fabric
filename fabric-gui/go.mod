...
require (
	...
	github.com/danielmiessler/fabric v0.0.0-20250608145749-d901614742a0
)

// Replace remote Fabric module with local path
replace github.com/danielmiessler/fabric => ../
